...
{
    private static int preventMaxNum = 5; //绒毛最多阻挡数量

    private static Vector2 spawnIntervalRange = new Vector2(1.0f, 2.5f);  //生成时间间隔

    private static float speed = 5.0f;  // 病毒移动速度

    private static int maxGenerateNum = 1000;  // 最大生成病毒数量
